...
Start here when navigating the repository documentation.

- [Codebase Guide](CODEBASE_GUIDE.md): module, class, and function overview.
- [Pipeline Flow](PIPELINE_FLOW.md): execution order for scans and trades.
- [Matching Safety](MATCHING_SAFETY.md): false-positive guardrails.
